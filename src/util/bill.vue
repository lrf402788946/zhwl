<template lang="html">
  <div id="bill">
    <div class="contExt">
      ...
      <div class="yearExt"><span>1233</span>年<span>33</span>月<span>33</span>日</div>
      ...
      <div class="applicantExt ">
        ...
        <div class="paymentTxt">
          <div class="pay">
            <div class="payList">
              ( <span> {{ billInfo.value }} </span> )
            </div>
            <div class="payList">现金</div>
          </div>
          <div class="pay marNone">
            <div class="payList padd5">( <span> 1 </span> )</div>
            <div class="payList">银行汇款</div>
          </div>
        </div>
      </div>
      <div class="applicantExt mar0">
      ...
      <div class="applicantExt mar0">
        ...
        <div class="paymentTxt">￥：<span></span></div>
      </div>
      <div class="applicantExt">
        <p class="payment">付款金额（大写）</p>
        <div class="paymentTxt">
          ￥：<span>1</span>佰<span>1</span>拾<span>1</span>万<span>1</span>仟<span>1</span>佰<span>1</span>拾<span>1</span>元<span>1</span>角<span>1</span>分
        </div>
      </div>
      <div class="applicantExt mar0">
...
export default {
  ...
  computed: {
    ...mapState({
      billInfo: state => state.settlement.billInfo,
    }),
  },
  methods: {},
};
